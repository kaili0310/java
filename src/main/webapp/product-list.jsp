						...
						<div class="table-box">
							...
							<table id="dataList"
								...
								<tbody>
									...
									<c:forEach items="${pageInfo.list}" var="product" varStatus="stat">

										<tr>
											<td><input name="test" type="checkbox" value="${product.id}" onclick="jqchk()" ></td>
											<td>${product.id }</td>
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/product-add.jsp'">
											<i class="fa fa-file-o"></i> 新建
										</button>
