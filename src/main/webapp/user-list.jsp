								...
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="删除"
											onclick="location.href='${pageContext.request.contextPath}/product/del.do'">
								...
								<tbody>
									...
									<c:forEach items="${pageInfo.list}" var="userlist">
										...
										<tr>
											...
											<td class="text-center">${userlist.statusStr}</td>
											<td class="text-center">
								
												<button type="button" class="btn bg-olive btn-xs">
													<a href="${pageContext.request.contextPath}/user/findById.do?id=${userlist.id}" class="btn bg-olive btn-xs">
														详情
													</a>
												
												</button>
												<button type="button" class="btn bg-olive btn-xs" >
													<a href="${pageContext.request.contextPath}/user/findUserByIdAndAllRole.do?id=${userlist.id}" class="btn bg-olive btn-xs">
														添加角色
													</a>
